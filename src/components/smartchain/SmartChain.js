          ...
          <SmartChainDiv>
            <SmartChainListContainer>
              <SmartChainListItemLeft>
                ...
                <P>
                  ...
                  (V-DPoS) with the unique ability of processing over <strong>1 million Transaction per second</strong>{" "}
            ...
            <SmartChainListContainer>
              <SmartChainListItemLeft>
                ...
                <P>VEFI Smart Chain enables multi-chain Interoperability, which makes it easier to scale DApps.</P>
                <div>
                  <Button text="show more" icon={<AiOutlineArrowDown />} />
                </div>
              </SmartChainListItemLeft>
